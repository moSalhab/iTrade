...
class ShowUserInfoViewController: UIViewController {
    ...
    var  getUserInfo: GetSentTradeDetails!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if getUserInfo.trade.contactInformation.party2Name != nil {
            userName.text = getUserInfo.trade.contactInformation.party2Name
        }
        
        if getUserInfo.trade.contactInformation.party2PhoneNumber != nil {
            
            phoneNumber.text = getUserInfo.trade.contactInformation.party2PhoneNumber
        }
        
        if getUserInfo.trade.contactInformation.party2Address != nil {
            address.text = getUserInfo.trade.contactInformation.party2Address
        }
